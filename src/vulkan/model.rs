...
impl Mesh {
    ...
    pub fn add_quad(&mut self, direction: Direction, position: IVec3, block: Block) {
        self.add_quad_vertices(direction, position, block);
        self.compute_quad_indices();
    }

    fn add_quad_vertices(&mut self, direction: Direction, position: IVec3, block: Block) {
